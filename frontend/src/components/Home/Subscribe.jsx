    ...
    <div>
      <div className="flex justify-around items-center mt-30">
        <div className="flex justify-center flex-col items-center">
          <img
            ...
            alt=""
          />
          <h1 className="font-semibold text-zinc-800">Easy Exchange Policy</h1>
        ...
        <div className="flex flex-col items-center justify-center">
          <img
            ...
            alt=""
          />
          <h1 className="font-semibold text-zinc-800">7 Days Return Policy</h1>
          <h1 className="text-zinc-500 font-semibold">
      ...
      <div className="flex flex-col items-center justify-center mt-20">
        ...
        <div className="flex items-center gap-2">
          <div>
            <input
              className="mt-5 border-1 w-[40vw] py-3 p-5"
              type="email"
              placeholder="Enter your email"
            />
          </div>
          <div>
            <button className="px-5 py-3 p-5 bg-black text-white mt-5 rounded">SUBSCRIBE</button>
          </div>
        </div>
      </div>
    </div>
